...
import { fieldNameToLabel } from '../../utils/fieldNameToLabel';
...
const fields: RegisterFields[] = ['email', 'password'];
    ...
    <div className='h-full flex items-center justify-center'>
      ...
      >
        ...
        <div className='flex flex-col gap-4 desktop:w-[300px] mx-auto'>
          ...
          <p className='font-light text-sm'>Doesn't have account? <Link className='text-green-400 underline' to='/register'>create</Link> one!</p>
        </div>
      </form>
    </div>
  )
